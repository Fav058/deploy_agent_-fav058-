...
The walkthrough is hosted online — the repo only stores a **link**, never a
raw `.mp4` upload (GitHub rejects large binaries and the rubric expects a
shareable URL).

- Demo video (YouTube): https://youtu.be/example-walkthrough
- Demo video (Loom mirror): https://www.loom.com/share/example-walkthrough
